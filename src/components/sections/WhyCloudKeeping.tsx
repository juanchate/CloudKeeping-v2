...
interface Props { content: Dictionary["whyUs"] }

export function WhyCloudKeeping({ content }: Props) {
  return (
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          {content.items.map((prop) => (
            <div key={prop.title} className="text-center">
              ...
              <h3 className="mb-2 text-base font-semibold tracking-tight text-foreground">{prop.title}</h3>
