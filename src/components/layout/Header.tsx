        ...
        >
          ...
          <div className="hidden lg:flex lg:items-center lg:gap-2">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-medium text-muted transition-colors hover:text-foreground hover:bg-surface"
              title="WhatsApp"
            >
